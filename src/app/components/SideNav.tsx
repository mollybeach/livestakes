...
const SideNav = () => {
  ...
  return (
    <aside className={`${isCollapsed ? 'w-16' : 'w-52'} bg-fuchsia text-cream flex flex-col gap-2 py-6 border-r-4 border-black transition-all duration-300 relative`}>
      ...
      {!isCollapsed && (
        <Button className="mx-3 mt-6 bg-gold hover:bg-butter text-black border border-black uppercase tracking-wider">
          Create Market
        </Button>
      )}
      ...
      <div className="mt-auto px-3 pb-4">
        <div className="flex flex-col gap-2">
          ...
          >
            ...
            {!isCollapsed && <span className="text-xs">GitHub</span>}
          </a>
          <a 
          ...
          >
            ...
            {!isCollapsed && <span className="text-xs">Twitter</span>}
          </a>
        </div>
      </div>
    </aside>
