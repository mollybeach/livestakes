      ...
      <nav className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <div className="flex space-x-6">
            ...
            <Link href="/markets" className="flex items-center gap-2 text-yellow-50 hover:text-yellow-200 transition-colors font-pixel text-sm border border-transparent  px-2 py-1">
              <Store size={16} />
              <span>Markets</span>
            </Link>
          </div>
          ...
          <div className="flex space-x-2">
            ...
            <a href="https://github.com/mollybeach/livestakes" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center text-yellow-50 hover:text-yellow-200 transition-colors font-pixel text-sm border border-transparent px-2 py-1">
            ...
            <a href="https://twitter.com/livestakes" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center text-yellow-50 hover:text-yellow-200 transition-colors font-pixel text-sm border border-transparent px-2 py-1">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
